...
with DAG(dag_id="forex_data_pipeline",
    ...
    extract_currency_rates = PythonOperator(
    ...
    insert_data_to_table_by_spark = SparkSubmitOperator(
        task_id="insert_data_to_table_by_spark",
    ...
    is_forex_rates_available >> is_forex_currencies_file_available >> extract_currency_rates >> saving_rates >> creating_forex_rates_table >> insert_data_to_table_by_spark >> send_email_notification